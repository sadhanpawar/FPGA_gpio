...
#
# Script generated by Vivado on Tue Oct 24 20:44:53 CDT 2023
...
# script info
echo -e "vio_1.sh - Script generated by export_simulation (Vivado v2023.1.1 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../gpio.gen/sources_1/ip/vio_1/hdl/verilog" +incdir+"../../../../gpio.gen/sources_1/ip/vio_1/hdl" +incdir+"/home/sadhanpawar/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../gpio.gen/sources_1/ip/vio_1/hdl/verilog" +incdir+"../../../../gpio.gen/sources_1/ip/vio_1/hdl" +incdir+"/home/sadhanpawar/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../gpio.gen/sources_1/ip/vio_1/hdl/verilog" +incdir+"../../../../gpio.gen/sources_1/ip/vio_1/hdl" +incdir+"/home/sadhanpawar/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.vio_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.vio_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log vio_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
