...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot vio_1 xil_defaultlib.vio_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim vio_1 -key {Behavioral:sim_1:Functional:vio_1} -tclbatch cmd.tcl -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/sadhanpawar/Xilinx/Vivado/2023.1/data/xsim"
  fi
