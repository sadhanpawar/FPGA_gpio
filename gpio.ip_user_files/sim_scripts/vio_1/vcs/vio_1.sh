...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../gpio.gen/sources_1/ip/vio_1/hdl/verilog" +incdir+"../../../../gpio.gen/sources_1/ip/vio_1/hdl" +incdir+"/home/sadhanpawar/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../gpio.gen/sources_1/ip/vio_1/hdl/verilog" +incdir+"../../../../gpio.gen/sources_1/ip/vio_1/hdl" +incdir+"/home/sadhanpawar/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../gpio.gen/sources_1/ip/vio_1/hdl/verilog" +incdir+"../../../../gpio.gen/sources_1/ip/vio_1/hdl" +incdir+"/home/sadhanpawar/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/sadhanpawar/UTA/SOC/FPGA/gpio/gpio.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key vio_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc vio_1_simv.daidir vcs_lib c.obj)
